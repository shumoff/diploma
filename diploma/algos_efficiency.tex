...
Оценка качества алгоритма представлена на таблице~\ref{tab:memory_based_quality}
\vspace{1em}
\begin{table}[h]
    \resizebox{\textwidth}{!}{%
...
Графики кривых при $\alpha = 0.6$ представлены на рисунках~\ref{fig:memory_based_roc} и~\ref{fig:memory_based_pr}:
...
Оценка качества алгоритма представлена на таблице~\ref{tab:hybrid_quality}
\vspace{1em}
\begin{table}[h]
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{ |P{4.5em}|P{2.5em}|P{2.5em}|P{2.5em}|P{2.5em}|P{2.5em}|P{2.5em}|P{2.5em}|P{2.5em}|P{2.5em}|P{2.5em}|P{2.5em}|}
...
Графики кривых при $\alpha = 0.3$ представлены на рисунках~\ref{fig:hybrid_roc} и~\ref{fig:hybrid_pr}:
